...
interface OptimizedSubscriptionGuardProps {
...
const OptimizedSubscriptionGuard: React.FC<OptimizedSubscriptionGuardProps> = ({
  children,
  requiredPlan,
  pageName,
  description
  ...
  // Si pas encore initialisé, ne rien afficher (OptimizedRoute gère la redirection)
  ...
  const hasAccess = hasPermission(pageName as any);
...
export default OptimizedSubscriptionGuard;
