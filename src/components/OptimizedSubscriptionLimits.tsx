...
interface OptimizedSubscriptionLimitsProps {
  resource: 'clients' | 'orders' | 'projects' | 'storage' | 'teamMembers';
  currentCount: number;
  onUpgrade?: () => void;
}

const OptimizedSubscriptionLimits: React.FC<OptimizedSubscriptionLimitsProps> = ({
  resource,
  currentCount,
  onUpgrade
}) => {
    ...
    return (
      <div className="bg-red-500/20 border border-red-500/30 rounded-lg p-3">
        ...
        <p className="text-gray-400 text-sm mb-3">
          Vous avez atteint la limite de {limit} {resourceLabels[resource].toLowerCase()}.
        </p>
...
export default OptimizedSubscriptionLimits;
