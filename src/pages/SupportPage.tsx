    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <Link to="/#features" className="text-gray-600 hover:text-gray-900 transition-colors">{t('support.features')}</Link>
              <Link to="/pricing" className="text-gray-600 hover:text-gray-900 transition-colors">{t('support.pricing')}</Link>
              <span className="text-blue-600 font-medium">{t('support.support')}</span>
            </nav>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            <div className="inline-flex items-center px-3 py-1.5 rounded-full bg-blue-100 text-blue-800 text-xs font-semibold mb-5">
              <HelpCircle className="w-4 h-4 mr-2" /> {t('support.here.to.help')}
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Button asChild className="px-6 py-3">
                <a href="#faq">{t('support.browse.faq')}</a>
              </Button>
              <Button asChild className="bg-gray-100 text-gray-800 hover:bg-gray-200 px-6 py-3">
                <Link to="/register">{t('support.start.free.trial')}</Link>
              </Button>
            </div>
          </div>
          <div className="rounded-2xl border border-gray-200 bg-white shadow-xl p-6">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <Link to="#" className="group rounded-xl border border-gray-200 hover:border-gray-300 p-5 transition">
                ...
                <div className="font-semibold text-gray-900">{t('support.documentation')}</div>
                <div className="text-sm text-gray-500">{t('support.documentation.desc')}</div>
              ...
              <Link to="#" className="group rounded-xl border border-gray-200 hover:border-gray-300 p-5 transition">
                ...
                <div className="font-semibold text-gray-900">{t('support.blog')}</div>
                <div className="text-sm text-gray-500">{t('support.blog.desc')}</div>
                <ArrowRight className="w-4 h-4 text-gray-400 mt-3 group-hover:translate-x-1 transition" />
              </Link>
              <a href="mailto:support@fiverflow.app" className="group rounded-xl border border-gray-200 hover:border-gray-300 p-5 transition">
                ...
                <div className="font-semibold text-gray-900">{t('support.contact')}</div>
      ...
      <section id="faq" className="py-16">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">{t('support.faq.title')}</h2>
          <FAQ
            items={[
              {
                q: t('support.faq.trial.question'),
                a: t('support.faq.trial.answer'),
              },
              {
                q: t('support.faq.platforms.question'),
                a: t('support.faq.platforms.answer'),
              },
              {
                q: t('support.faq.invoices.question'),
                a: t('support.faq.invoices.answer'),
              },
              {
                q: t('support.faq.security.question'),
                a: t('support.faq.security.answer'),
              },
              {
                q: t('support.faq.cancel.question'),
                a: t('support.faq.cancel.answer'),
              },
            ]}
          />
        </div>
