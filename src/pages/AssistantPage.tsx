    ...
    <div className="flex flex-col overflow-hidden bg-slate-950 -m-6 sm:-m-6" style={{ height: '100vh', maxHeight: '100vh' }}>
      ...
      {activeTab === 'chat' ? (
        <div className="flex-1 flex flex-col overflow-hidden bg-slate-900" style={{ minHeight: 0, height: 0 }}>
          {/* Messages */}
          <div className="flex-1 overflow-y-auto p-3 sm:p-4 md:p-6 lg:p-8 space-y-3 sm:space-y-4 max-w-5xl mx-auto w-full scrollbar-hide" style={{ minHeight: 0, scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
            {isLoadingHistory && (
