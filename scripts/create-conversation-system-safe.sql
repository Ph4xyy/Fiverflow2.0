-- =====================================================
-- SYSTÈME DE CONVERSATION - SCRIPT SÉCURISÉ
-- =====================================================
-- Ce script gère les éléments existants en les supprimant d'abord
...
-- 4. Supprimer les tables existantes (dans l'ordre inverse des dépendances)
