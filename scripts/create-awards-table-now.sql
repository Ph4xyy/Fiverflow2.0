-- Script URGENT pour créer la table user_awards
...
-- Créer la table user_skills si elle n'existe pas
...
CREATE INDEX idx_user_awards_date ON user_awards(date_received);
CREATE INDEX idx_user_skills_user_id ON user_skills(user_id);

SELECT 'Tables user_awards et user_skills créées avec succès!' as status;
