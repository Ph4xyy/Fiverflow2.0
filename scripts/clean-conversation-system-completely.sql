...
-- 1. Supprimer TOUS les triggers d'abord
DROP TRIGGER IF EXISTS trigger_update_conversation_on_message ON messages;
DROP TRIGGER IF EXISTS trigger_update_conversation_updated_at ON messages;

-- 2. Supprimer TOUTES les fonctions (avec CASCADE pour les dépendances)
...
-- 5. Désactiver RLS sur toutes les tables restantes
